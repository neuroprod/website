...
export default class FxaaMaterial extends Material {
    setup() {
...
fn QUALITY(q: i32) -> f32 {
   ...
   // const EDGE_THRESHOLD_MAX: f32 = 0.125;
     const EDGE_THRESHOLD_MIN: f32 = 0.0012;
    const EDGE_THRESHOLD_MAX: f32 = 0.0020;
...
fn mainVertex( ${this.getShaderAttributes()} ) -> VertexOutput
{
    ...
    output.position = vec4f(aPos, 1.0);
    output.uv0 = aUV0;
    return output;
}
