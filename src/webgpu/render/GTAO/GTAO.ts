...
export default class GTAO {
    ...
    public add() {
        ...
        this.passEncoder.setBindGroup(1, this.camera.bindGroup)
    ...
    getPipeLine() {
        ...
        this.pipeLineLayout = this.renderer.device.createPipelineLayout({
            ...
            bindGroupLayouts: [this.uniformGroup.bindGroupLayout, this.camera.bindGroupLayout],
        });
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    visibility = clamp(visibility, 0.001, 1.0);

    textureStore(ambient_occlusion, pixel_coordinates, vec4<f32>(visibility*visibility, 0.0, 0.0, 0.0));
}
