...
export default class PostLightRenderPass extends RenderPass{

    private colorAttachment: ColorAttachment;
    public modelRenderer: ModelRenderer;

    constructor(renderer:Renderer,camera:Camera,dirLight:DirectionalLight,modelRenderer: ModelRenderer) {
        super(renderer,"PostLightRenderPass");
        this.modelRenderer =modelRenderer;
        this.colorAttachment = new ColorAttachment(renderer.getTexture(Textures.GRADING),{ loadOp: LoadOp.Load});
