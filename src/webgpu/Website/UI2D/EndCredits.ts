...
export default class EndCredits {
  ...
  constructor(renderer: Renderer) {
    ...
    this.thanks = new Text(renderer, font, 35, endText, hAlign);
    this.thanks.material.setUniform("color", this.color)
    this.thanks.y = pos
    this.root.addChild(this.thanks)
